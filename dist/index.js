...
exports.init = function (opts) {
  ...
  exports.getModelName = utils.getModelName; // TODO: Remove nameOld attribute once the lianas versions older than 2.0.0 are minority
  ...
  exports.Stripe = {
    ...
    getCustomerByUserField: function getCustomerByUserField(customerModel, customerField, userField) {
      return new P(function (resolve, reject) {
        ...
        customerModel.findOne(query).lean().exec(function (err, customer) {
          if (err) {
            return reject(err);
          }
